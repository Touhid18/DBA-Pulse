...
public class OnlineAdminAdapter extends ArrayAdapter<OnlineAdminRow> {
	...
	public OnlineAdminAdapter(Context context, int resource, ArrayList<OnlineAdminRow> adminList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tvAdminName = (TextView) convertView.findViewById(R.id.tv_admin_name);
			holder.tvActiveCount = (TextView) convertView.findViewById(R.id.tv_active_count);
			holder.tvPendingCount = (TextView) convertView.findViewById(R.id.tv_pending_count);
			holder.tvResolvedCount = (TextView) convertView.findViewById(R.id.tv_resolved_count);
			holder.ivStatus = (ImageView) convertView.findViewById(R.id.iv_status);
			holder.btnMessage = (Button) convertView.findViewById(R.id.btn_msg_admin);
